...
func (c *cachedDataSource) Get(ctx context.Context, key []byte) (middleware.Response, error) {
...
func (c *cachedDataSource) Create(ctx context.Context, data []byte) (middleware.Response, error) {
...
func (c *cachedDataSource) Update(ctx context.Context, data []byte) (middleware.Response, error) {
